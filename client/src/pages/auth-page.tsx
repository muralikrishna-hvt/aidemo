                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="password"
                              placeholder="Enter your password (e.g., Password@1234)"
                              {...field}
        ...
        <div className="hidden lg:block">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            ...
            <p className="text-gray-600 text-lg mb-6">
              WealthAdvisor AI leverages cutting-edge artificial intelligence to
              provide personalized financial insights, real-time market
              analysis, and investment opportunities tailored to your goals.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Gemini with Model Context Protocol (MCP) delivers
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Get real-time analysis of your investments, asset
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Set financial goals and track your progress with AI-assisted
                    recommendations to reach them faster.
                  </p>
                </div>
              </div>
            </div>
